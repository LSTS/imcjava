 ...
 *
 */
public class DesiredAssetPosition extends IridiumMessage {

    double latDegs, lonDegs;
    public int asset_imc_id;
    
    public DesiredAssetPosition() {
        super(2006);
    }
    ...
    public int serializeFields(IMCOutputStream out) throws Exception {
        ...
        out.writeInt((int)Math.round(latDegs * 1000000));
        out.writeInt((int)Math.round(lonDegs * 1000000));
        return 10;
    }
    ...
    public int deserializeFields(IMCInputStream in) throws Exception {
        ...
        latDegs = in.readInt() / 1000000.0;
        lonDegs = in.readInt() / 1000000.0;
        return 10;
    }
	...
	/**
	 * @param latDegs the latDegs to set
	 */
	...
	/**
	 * @param lonDegs the lonDegs to set
	 */
    ...
    public Collection<IMCMessage> asImc() {
        ...
        sensorInfo.setLat(Math.toRadians(latDegs));
        sensorInfo.setLon(Math.toRadians(lonDegs));
